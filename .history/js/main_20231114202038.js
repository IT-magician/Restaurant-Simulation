...
function displayDrawerFunc(orderInfoList, name = null) {
  ...
  for (let orderInfo of orderInfoList) {
    ...
    document.querySelector(".order-display > #waiting").innerHTML =
      orderWaitingTrHTML;
    document.querySelector(".order-display > #cooking").innerHTML =
      orderCookingTrHTML;
    document.querySelector(".order-display > #serving").innerHTML =
      orderServingTrHTML;
  }
}
