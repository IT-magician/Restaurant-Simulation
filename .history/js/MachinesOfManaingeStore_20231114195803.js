...
class OrderManager {
  ...
  #update(uuid, progressStatusName) {
    // const idx = this.#orderList.map((item) =>
    //   item.orderNumber === uuid
    //     ? {
    //         ...item,
    //         statusName: this.progressStatusName,
    //       }
    //     : item
    // );
    ...
    this.#orderList[0].statusName = progressStatusName; //progressStatusName;

    console.log(this.#orderList, uuid, progressStatusName);
    this.#displayDrawerFunc(this.#orderList, progressStatusName);
  }
