...
class OrderManager {
  ...
  #update(uuid, progressStatusName) {
    ...
    if (idx === -1) return;
    console.log(progressStatusName);
    this.#orderList[0].statusName = "aaaaa" + progressStatusName;

    console.log(this.#orderList[0].statusName, this.#orderList);
    console.log(idx, this.#orderList[0], uuid, progressStatusName);
