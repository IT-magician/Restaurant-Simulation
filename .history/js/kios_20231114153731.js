import { Food, sundaeSoop, SoopForHangingOver } from "./food";

/**
 * OrderManger는 1:1, 1:N 모두가 될 수 있음. 1:1은 자기자신, 1:N인 경우는 워커쓰레드처럼 자기 자신이 로드밸런서 역할을 하는 것으로 설계했음.
 */
class OrderManager {
  #orderList = [];
...
class MainThreadOfOrderManagerModel extends OrderManager {}
class WorkerThreadOfOrderManagerModel extends OrderManager {}
